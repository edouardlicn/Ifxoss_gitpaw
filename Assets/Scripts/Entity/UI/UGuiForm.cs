...
namespace CatPaw
{
    public abstract class UGuiForm : UIFormLogic
    {
        ...
        public void Close(int toActiveWhenClosed)
        {
            m_ToActiveWhenClosed = (UIFormId)toActiveWhenClosed;
        ...
        UIFormId m_ToActiveWhenClosed = UIFormId.Undefined;
        ...
        public void Close(bool ignoreFade)
        {
            ...
            if (ignoreFade)
            {
                ...
                if(m_ToActiveWhenClosed != UIFormId.Undefined)
                {
                    ActiveUIForm(m_ToActiveWhenClosed);
                }
            }
            else
            {
