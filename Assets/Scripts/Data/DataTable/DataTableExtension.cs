...
namespace CatPaw {
    ...
    public static class DataTableExtension {
        ...
        private const string DataRowClassPrefixName = "CatPaw.DR";
        ...
        public static void LoadDataTable(this DataTableComponent dataTableComponent, string dataTableName, object userData = null) {
            ...
            string dataRowClassName = DataRowClassPrefixName + dataTableName;
            ...
            dataTableComponent.LoadDataTable(dataRowType, dataTableName, null,
            AssetUtility.GetDataTableAsset(dataTableName), Constant.AssetPriority.DataTableAsset, userData);
        }
